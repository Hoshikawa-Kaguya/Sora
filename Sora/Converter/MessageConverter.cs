    ...
    internal static class MessageConverter
    {
        ...
        private static SoraSegment ParseMessageElement(OnebotSegment onebotSegment)
        {
            ...
            try
            {
                ...
                {
                    SegmentType.Text =>
                        new SoraSegment(SegmentType.Text, jsonObj.ToObject<TextSegment>()),
                    SegmentType.Face =>
                        new SoraSegment(SegmentType.Face, jsonObj.ToObject<FaceSegment>()),
                    SegmentType.Image =>
                        new SoraSegment(SegmentType.Image, jsonObj.ToObject<ImageSegment>()),
                    SegmentType.Record =>
                        new SoraSegment(SegmentType.Record, jsonObj.ToObject<RecordSegment>()),
                    SegmentType.At =>
                        new SoraSegment(SegmentType.At, jsonObj.ToObject<AtSegment>()),
                    SegmentType.Share =>
                        new SoraSegment(SegmentType.Share, jsonObj.ToObject<ShareSegment>()),
                    SegmentType.Reply =>
                        new SoraSegment(SegmentType.Reply, jsonObj.ToObject<ReplySegment>()),
                    SegmentType.Forward =>
                        new SoraSegment(SegmentType.Forward, jsonObj.ToObject<ForwardSegment>()),
                    SegmentType.Xml =>
                        new SoraSegment(SegmentType.Xml, jsonObj.ToObject<CodeSegment>()),
                    SegmentType.Json =>
                        new SoraSegment(SegmentType.Json, jsonObj.ToObject<CodeSegment>()),

                    _ => new SoraSegment(SegmentType.Unknown, new UnknownSegment
                    {
                        Content = jsonObj
                    })
                };
