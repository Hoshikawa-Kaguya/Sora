    ...
    public async Task SendReceive_Text_SpecialCharacters()
    {
        ...
        try
        {
            ...
            Assert.True(
                ...
                "Primary did not receive the special text message within timeout");
...
#region Mention Messages
    ...
    public async Task SendReceive_Mention()
    {
        ...
        BotIdentity primarySelfInfo = (await _fixture.PrimaryApi!.GetSelfInfoAsync(CT)).AssertSuccess();
    ...
    public async Task Send_MentionAll()
    {
        ...
        try
        {
            ...
            sent = await _fixture.PrimaryApi!.SendGroupMessageAsync(testGroup, body, CT);
        ...
        {
            if (sent is { IsSuccess: true })
                await _fixture.PrimaryApi!.RecallGroupMessageAsync(testGroup, sent.Value.MessageId, CT);
        }
    }
...
#region Reply Messages
    ...
    public async Task SendReceive_Reply()
    {
        ...
        SendMessageResult originalSent =
            await _fixture.PrimaryApi!.SendGroupMessageAsync(testGroup, new MessageBody($"{marker} original"), CT);
        ...
        finally
        {
            ...
            await _fixture.PrimaryApi!.RecallGroupMessageAsync(testGroup, originalSent.MessageId, CT);
        }
    }
...
#region Multi-Segment Messages
    ...
    public async Task SendReceive_MultiSegment()
    {
        ...
        ApiResult<BotIdentity> primarySelf     = await _fixture.PrimaryApi!.GetSelfInfoAsync(CT);
...
#region Forward Messages
    ...
    public async Task Send_Forward()
    {
        ...
        BotIdentity selfData = (await _fixture.PrimaryApi!.GetSelfInfoAsync(CT)).AssertSuccess();
